...
- application-dev.ymlでプロファイル管理
- データベースマイグレーションの基礎
- **成果物**: MySQLで動作するアプリケーション

---

### 🏗️ Phase 3: アーキテクチャとベストプラクティス (6ステップ)

#### Step 13: レイヤー化アーキテクチャ
**目標**: 責務を分離した設計を学ぶ
...
### 🔒 Phase 4: セキュリティとテスト (5ステップ)

#### Step 19: Spring Securityの基礎
**目標**: 認証・認可の基本を理解
...
### 🎯 Phase 6: 総合演習（最終プロジェクト）

#### Step 28-32: ミニブログアプリケーション開発
