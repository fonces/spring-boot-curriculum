...
- Phase 3までのベストプラクティスが理解できていること
- ユーザー管理機能が実装されていること

**Phase 3をまだ完了していない場合**: [Phase 3](../phase3/STEP_13.md)を先に進めてください。
...
```bash
git add .
git commit -m "Phase 4: STEP_19完了（Spring Security基礎実装）"
...
次は[Step 20: JWT認証](STEP_20.md)へ進みましょう！
