...
- Step 13のDTOパターンが理解できていること
- UserCreateRequest、UserUpdateRequestが実装されていること

**Step 13をまだ完了していない場合**: [Step 13: レイヤードアーキテクチャとDTOパターン](STEP_13.md)を先に進めてください。
...
```bash
git add .
git commit -m "Phase 3: STEP_14完了（バリデーション実装）"
...
次は[Step 15: 例外ハンドリング](STEP_15.md)へ進みましょう！
